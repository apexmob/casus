...
import com.apexmob.casus.client.stomp.SimpleWebSocketContainerProvider;
...
public class SampleStompModule extends BaseModule {
    ...
    public void start(GameEngine game) {
        ...
        if (configurationService != null) {
            ...
            configurationService.setWebSocketContainerProvider(new SimpleWebSocketContainerProvider());
        }
